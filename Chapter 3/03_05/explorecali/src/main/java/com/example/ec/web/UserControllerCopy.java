...
public class UserControllerCopy {
    private static final Logger LOGGER = LoggerFactory.getLogger(UserControllerCopy.class);
    ...
    @PostMapping("/signup")
    @PreAuthorize("hasRole('ROLE_ADMIN')") // user needs to be an admin to signup
