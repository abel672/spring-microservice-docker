 ...
 */
@Component
public class ExploreCaliUserDetailsServiceExample implements UserDetailsService {
    @Autowired
    private UserRepository userRepository;

    /**
     * Checking the user credentials in the database here
     * @param s
     * @return
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        // here we check if the user's password is correct
